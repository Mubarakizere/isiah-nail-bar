                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" required rows="4"
                                  class="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition outline-none resize-vertical"><?php echo e(old('description', $service->description)); ?></textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="tags"
                               value="<?php echo e(old('tags', $service->tags->pluck('tag')->implode(', '))); ?>"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\admin\services\edit.blade.php ENDPATH**/ ?>