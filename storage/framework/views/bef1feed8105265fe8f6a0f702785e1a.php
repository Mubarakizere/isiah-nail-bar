...
<div class="container py-4">
    ...
    <form action="<?php echo e(route('provider.services.update', $service->id)); ?>" method="POST" enctype="multipart/form-data" class="card shadow-sm border-0 p-4">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $service->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="duration_minutes" class="form-control <?php $__errorArgs = ['duration_minutes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('duration_minutes', $service->duration_minutes)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                   value="<?php echo e(old('category', $service->category)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <img id="previewImage" src="<?php echo e($service->image ? asset('storage/' . $service->image) : 'https://via.placeholder.com/100x100?text=Preview'); ?>"
                 class="img-thumbnail mb-2" width="100" alt="Preview">

            <input type="file" name="image" accept="image/*" class="form-control mt-2 <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" onchange="previewSelectedImage(event)">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="d-flex justify-content-between align-items-center">
            <a href="<?php echo e(route('provider.services.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\dashboard\provider\services\edit.blade.php ENDPATH**/ ?>