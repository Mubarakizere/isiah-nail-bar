<?php $__env->startSection('title', 'Provider Performance Report'); ?>
...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600"><?php echo e($provider->user->name ?? 'Provider'); ?>'s detailed performance metrics</p>
            </div>
            <a href="<?php echo e(route('dashboard.admin.reports.pdf')); ?>" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <h3 class="text-3xl font-bold mb-1"><?php echo e(number_format($totalBookings)); ?></h3>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <h3 class="text-3xl font-bold mb-1"><?php echo e(number_format($completedBookings)); ?></h3>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <h3 class="text-3xl font-bold mb-1"><?php echo e($completionRate); ?>%</h3>
            <p class="text-purple-100 text-sm">Completion Rate</p>
            <div class="mt-3">
                <div class="w-full bg-white/20 rounded-full h-2">
                    <div class="bg-white rounded-full h-2 transition-all" style="width: <?php echo e($completionRate); ?>%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <h3 class="text-3xl font-bold mb-1">RWF <?php echo e(number_format($totalRevenue)); ?></h3>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\dashboard\admin\provider-performance.blade.php ENDPATH**/ ?>