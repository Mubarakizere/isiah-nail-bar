<?php $__env->startSection('page-title', 'Add Google Review'); ?>
<?php $__env->startSection('page-subtitle', 'Manually add a review from your Google Business profile'); ?>
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form action="<?php echo e(route('admin.reviews.store')); ?>" method="POST" class="p-8 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <input type="text" name="reviewer_name" id="reviewer_name" required
                       value="<?php echo e(old('reviewer_name')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div x-data="{ rating: <?php echo e(old('rating', 5)); ?> }">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="comment" id="comment" rows="4" required
                          ...
                          class="w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-all resize-none"><?php echo e(old('comment')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="date" name="review_date" id="review_date"
                       value="<?php echo e(old('review_date', now()->toDateString())); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="url" name="avatar_url" id="avatar_url"
                       value="<?php echo e(old('avatar_url')); ?>"
                       placeholder="https://..."
                       class="w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-all">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\dashboard\admin\reviews\create.blade.php ENDPATH**/ ?>