<?php $__env->startSection('title', 'Best Nail Salon in Kigali, Rwanda | Luxury Manicure & Pedicure'); ?>

<?php $__env->startSection('meta_description', 'Isaiah Nail Bar is the #1 nail salon in Kigali, Rwanda. Premium manicure, pedicure, gel polish, acrylic nails & nail art by expert technicians. ⭐ 4.9 rated. Book your appointment online today!'); ?>
...
<script type="application/ld+json">
{
  ...
  "aggregateRating": {
    ...
    "ratingValue": "<?php echo e($averageRating); ?>",
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-16">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-6">
                ...
                <span class="text-white/70 text-sm"><?php echo e($averageRating); ?></span>
            </div>
        ...
        <div x-data="{
                activeSlide: 0,
                slides: <?php echo e($sortedReviews->count()); ?>,
                next() {
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center gap-3">
                                <?php if($review->avatar_url): ?>
                                    <img src="<?php echo e($review->avatar_url); ?>" alt="<?php echo e($review->reviewer_name); ?>" class="w-12 h-12 rounded-full object-cover">
                                <?php else: ?>
            ...
            <div class="flex justify-center gap-2 mt-4 md:hidden">
                <?php $__currentLoopData = $sortedReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
