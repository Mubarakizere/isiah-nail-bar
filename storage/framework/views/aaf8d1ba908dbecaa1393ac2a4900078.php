...
<?php $__env->startSection('title', 'Manage Team Members'); ?>
...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.team_members.create')); ?>" 
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-full bg-gray-100 overflow-hidden flex-shrink-0">
                                        <?php if($member->photo): ?>
                                            <img src="<?php echo e(Storage::url($member->photo)); ?>" alt="<?php echo e($member->name); ?>" class="w-full h-full object-cover">
                                        <?php else: ?>
                                    ...
                                    <span class="font-semibold text-gray-900"><?php echo e($member->name); ?></span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold
                                    <?php echo e($member->active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('admin.team_members.edit', $member->id)); ?>" 
                                    ...
                                    <button type="button"
                                            ...
                                            data-url="<?php echo e(route('admin.team_members.destroy', $member->id)); ?>"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\admin\team_members\index.blade.php ENDPATH**/ ?>