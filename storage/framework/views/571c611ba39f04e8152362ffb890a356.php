<?php $__env->startSection('title', 'Request New Service'); ?>
...
<div class="container py-4">
    ...
    <form action="<?php echo e(route('provider.services.store')); ?>" method="POST" enctype="multipart/form-data" class="card shadow-sm border-0 p-4">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('duration_minutes')); ?>">
...
unset($__errorArgs, $__bag); ?>" onchange="previewImage(event)">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\dashboard\provider\services\request.blade.php ENDPATH**/ ?>