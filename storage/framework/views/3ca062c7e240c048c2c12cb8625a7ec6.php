...
<?php $__env->startSection('title', 'About Isaiah Nail Bar | Kigali\'s Premier Luxury Nail Salon'); ?>

<?php $__env->startSection('meta_description', 'Learn about Isaiah Nail Bar, Kigali\'s #1 luxury nail salon. 3+ years of excellence, 500+ happy clients, and 10,000+ manicures. Expert nail technicians, premium products & hospital-grade hygiene in Gisementi, Rwanda.'); ?>
<?php $__env->startSection('meta_keywords', 'about Isaiah Nail Bar, nail salon Kigali story, luxury nail salon Rwanda, Gisementi nail salon, best nail technician Kigali, nail art experts Rwanda, nail salon hygiene standards Kigali'); ?>
...
<script type="application/ld+json">
{
  ...
  "url": "<?php echo e(url('/')); ?>",
  "logo": "<?php echo e(asset('storage/logo.png')); ?>",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "About", "item": "<?php echo e(url('/about')); ?>"}
  ]
}
</script>
<?php $__env->stopPush(); ?>
...
<div class="relative bg-gray-900 py-32 overflow-hidden">
    <div class="absolute inset-0 opacity-30">
        <img src="<?php echo e(asset('storage/banner.jpg')); ?>" alt="About Us Banner" class="w-full h-full object-cover">
    </div>
                ...
                <div class="relative z-10 grid grid-cols-2 gap-4">
                    <div class="space-y-4 translate-y-8">
                        <div class="aspect-[3/4] rounded-2xl overflow-hidden bg-gray-100">
                            <img src="<?php echo e(asset('images/about-1.jpg')); ?>" onerror="this.src='https://images.unsplash.com/photo-1604654894610-df63bc536371?auto=format&fit=crop&q=80'" alt="Salon Interior" class="w-full h-full object-cover">
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="aspect-[3/4] rounded-2xl overflow-hidden bg-gray-100">
                             <img src="<?php echo e(asset('images/about-2.jpg')); ?>" onerror="this.src='https://images.unsplash.com/photo-1632345031435-8727f68979a6?auto=format&fit=crop&q=80'" alt="Nail Detail" class="w-full h-full object-cover">
                        </div>
                    </div>
                </div>
            </div>
...
<section class="py-24 bg-gray-900 text-center">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <a href="<?php echo e(route('booking.step1')); ?>" class="inline-block px-10 py-4 bg-white text-gray-900 font-medium rounded-full hover:bg-rose-50 transition-all transform hover:-translate-y-1">
            Book Appointment
        </a>
    </div>
</section>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\about.blade.php ENDPATH**/ ?>