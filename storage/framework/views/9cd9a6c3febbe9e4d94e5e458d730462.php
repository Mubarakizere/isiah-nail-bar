...
<?php $__env->startSection('title', 'Nail Art Gallery | Before & After Photos - Isaiah Nail Bar Kigali'); ?>

<?php $__env->startSection('meta_description', 'Browse our nail art gallery showcasing stunning manicure, pedicure, gel polish & acrylic nail designs at Isaiah Nail Bar in Kigali, Rwanda. See our work and get inspired for your next appointment!'); ?>
<?php $__env->startSection('meta_keywords', 'nail art gallery Kigali, nail designs Rwanda, manicure photos Kigali, pedicure gallery Rwanda, gel nails photos, acrylic nails gallery Rwanda, Isaiah Nail Bar gallery, nail inspiration Kigali'); ?>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Gallery", "item": "<?php echo e(url('/gallery')); ?>"}
  ]
}
</script>
<?php $__env->stopPush(); ?>
...
<div class="relative bg-gray-900 py-24 overflow-hidden">
    <div class="absolute inset-0 opacity-40">
        <img src="<?php echo e(asset('storage/banner.jpg')); ?>" alt="Gallery Banner" class="w-full h-full object-cover">
    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\gallery\index.blade.php ENDPATH**/ ?>