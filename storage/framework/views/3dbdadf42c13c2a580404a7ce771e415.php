...
<?php $__env->startSection('title', 'Contact Isaiah Nail Bar | Book Appointment Kigali Rwanda'); ?>

<?php $__env->startSection('meta_description', 'Contact Isaiah Nail Bar in Kigali, Rwanda. Call +250 790 395 169, WhatsApp us, or visit our salon at KG 4 Roundabout, Gisementi. Open Mon-Sat 8AM-8PM. Book your nail appointment today!'); ?>
<?php $__env->startSection('meta_keywords', 'contact Isaiah Nail Bar, nail salon phone Kigali, nail salon location Gisementi, nail salon WhatsApp Rwanda, book nail appointment Kigali, nail salon address Rwanda, nail salon opening hours Kigali'); ?>
...
<div class="relative bg-gray-900 py-24 overflow-hidden">
    <div class="absolute inset-0 opacity-40">
        <img src="<?php echo e(asset('storage/banner.jpg')); ?>" alt="Contact Banner" class="w-full h-full object-cover">
    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\contact\index.blade.php ENDPATH**/ ?>