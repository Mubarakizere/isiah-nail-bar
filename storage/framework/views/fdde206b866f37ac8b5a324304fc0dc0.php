...
<head>
    ...
    <meta charset="UTF-8">
    <title><?php echo $__env->yieldContent('title', 'Best Nail Salon in Kigali, Rwanda'); ?> | Isaiah Nail Bar</title>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Isaiah Nail Bar – The #1 Nail Salon in Rwanda. Luxury manicure, pedicure, gel polish, acrylic nails & nail art in Kigali. Book online today!'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'nail salon Rwanda, best nails Kigali, Isaiah Nail Bar, manicure Kigali, pedicure Kigali, gel polish Rwanda, acrylic nails Kigali, nail art Rwanda, beauty salon Gisementi, nail salon near me Kigali, nail technician Rwanda, luxury nails Rwanda, nail salon Kigali city, best manicure Rwanda, nail spa Kigali'); ?>">
    <meta name="author" content="Isaiah Nail Bar">
    <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">
    <link rel="canonical" href="<?php echo e(url()->current()); ?>">
    <link rel="alternate" hreflang="en-RW" href="<?php echo e(url()->current()); ?>">
    ...
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', 'Experience luxury nail care at Isaiah Nail Bar. Rwanda\'s top-rated manicure, pedicure & nail art salon in Kigali. Book online!'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('title', 'Isaiah Nail Bar'); ?> | Best Nail Salon in Rwanda">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('meta_description', 'Experience luxury nail care at Isaiah Nail Bar. Rwanda\'s top-rated manicure, pedicure & nail art salon in Kigali. Book online!'); ?>">
    <meta name="twitter:image" content="<?php echo $__env->yieldContent('og_image', asset('storage/cover.jpg')); ?>">
    ...
    <script type="application/ld+json">
    {
      ...
      "image": [
        "<?php echo e(asset('storage/logo.png')); ?>",
        "<?php echo e(asset('storage/cover.jpg')); ?>",
        "<?php echo e(asset('storage/banner.jpg')); ?>"
      ],
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute right-0 mt-4 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right scale-95 group-hover:scale-100">
                                <div class="p-2">
                                    ...
                                    <?php elseif(Auth::user()->hasRole('provider')): ?>
