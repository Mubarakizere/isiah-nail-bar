...
<?php $__env->startSection('page-subtitle', 'Update this carousel slide'); ?>
...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form method="POST" action="<?php echo e(route('admin.hero-slides.update', $heroSlide)); ?>" enctype="multipart/form-data" class="p-8 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="relative" x-data="{ preview: '<?php echo e(asset('storage/' . $heroSlide->image)); ?>' }">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="subtitle" id="subtitle" value="<?php echo e(old('subtitle', $heroSlide->subtitle)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="<?php echo e(old('title', $heroSlide->title)); ?>"
                       class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-sm">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-sm resize-none"><?php echo e(old('description', $heroSlide->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="button_text" id="button_text" value="<?php echo e(old('button_text', $heroSlide->button_text)); ?>"
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-sm">
                </div>
                <div>
                    <label for="button_url" class="block text-sm font-medium text-gray-700 mb-2">Primary Button URL</label>
                    <input type="text" name="button_url" id="button_url" value="<?php echo e(old('button_url', $heroSlide->button_url)); ?>"
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="secondary_button_text" id="secondary_button_text" value="<?php echo e(old('secondary_button_text', $heroSlide->secondary_button_text)); ?>"
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-sm">
                </div>
                <div>
                    <label for="secondary_button_url" class="block text-sm font-medium text-gray-700 mb-2">Secondary Button URL</label>
                    <input type="text" name="secondary_button_url" id="secondary_button_url" value="<?php echo e(old('secondary_button_url', $heroSlide->secondary_button_url)); ?>"
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="<?php echo e(old('sort_order', $heroSlide->sort_order)); ?>" min="0"
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-sm">
                </div>
                <div class="flex items-end pb-1">
                    <label class="relative inline-flex items-center cursor-pointer gap-3">
                        <input type="hidden" name="is_active" value="0">
                        <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $heroSlide->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\admin\hero-slides\edit.blade.php ENDPATH**/ ?>