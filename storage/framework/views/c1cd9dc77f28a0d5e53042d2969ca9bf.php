...
<div class="page-header text-center py-5 position-relative d-flex align-items-center justify-content-center" 
     style="background: linear-gradient(135deg, rgba(212, 113, 122, 0.8) 0%, rgba(45, 55, 72, 0.9) 100%), 
                      url('<?php echo e(asset('storage/images/header-bg.jpg')); ?>') center center / cover no-repeat;
            min-height: 300px;">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\components\page-header.blade.php ENDPATH**/ ?>