...
<?php $__env->startSection('page-subtitle', 'Real-time insight into your salon\'s performance'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white border-2 border-gray-300 p-5">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($totalRevenue)); ?> RWF</h3>
            </div>
            <div class="mt-4 pt-4 border-t border-gray-200 flex justify-between text-xs">
                <span class="text-gray-600">MOMO: <span class="font-semibold text-gray-900"><?php echo e(number_format($momoRevenue)); ?></span></span>
                <span class="text-gray-600">Card: <span class="font-semibold text-gray-900"><?php echo e(number_format($cardRevenue)); ?></span></span>
            </div>
        </div>
        ...
        <div class="bg-white border-2 border-gray-300 p-5">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($totalBookings)); ?></h3>
            </div>
        ...
        <div class="bg-white border-2 border-gray-300 p-5">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($totalCustomers)); ?></h3>
            </div>
        ...
        <div class="bg-gray-900 border-2 border-gray-900 p-5 text-white">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-white mt-1"><?php echo e(number_format($revenueAfterTax)); ?> RWF</h3>
            </div>
            <div class="mt-4 pt-4 border-t border-gray-700 flex justify-between text-xs">
                <span class="text-gray-400">Tax (5%): <?php echo e(number_format($taxAmount)); ?></span>
                <a href="<?php echo e(route('dashboard.admin.reports')); ?>" class="text-white hover:underline">Report →</a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white border-2 border-gray-300 p-6">
        ...
        <?php if(collect($last7DaysRevenue)->pluck('total')->sum() == 0): ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="<?php echo e(route('dashboard.admin.bookings')); ?>" class="bg-white border-2 border-gray-300 p-5 hover:border-gray-400 transition-colors">
        ...
        <a href="<?php echo e(route('dashboard.admin.reports')); ?>" class="bg-white border-2 border-gray-300 p-5 hover:border-gray-400 transition-colors">
            <div class="flex items-center gap-4">
        ...
        <a href="<?php echo e(route('admin.services.index')); ?>" class="bg-white border-2 border-gray-300 p-5 hover:border-gray-400 transition-colors">
            <div class="flex items-center gap-4">
...
window.addEventListener('load', function () {
    const chartData = <?php echo json_encode($last7DaysRevenue, 15, 512) ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\dashboard\admin.blade.php ENDPATH**/ ?>