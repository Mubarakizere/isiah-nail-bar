...
<?php $__env->startSection('title', 'Select Artist'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div class="lg:col-span-8">
                <form method="POST" action="<?php echo e(route('booking.step2.submit')); ?>" id="providerForm" class="space-y-6">
                    <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="group relative cursor-pointer block">
                                <input type="radio" 
                                       ...
                                       class="peer hidden"
                                       <?php echo e($providerId == $provider->id ? 'checked' : ''); ?>>
                                ...
                                <div class="relative bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 peer-checked:border-gray-900 peer-checked:ring-1 peer-checked:ring-gray-900 peer-checked:bg-gray-50 h-full flex flex-col items-center text-center">
                                    ...
                                    <div class="w-24 h-24 mb-4 relative">
                                        <div class="w-full h-full rounded-full overflow-hidden border-2 border-gray-100 group-hover:border-rose-200 transition-colors">
                                            <img src="<?php echo e($provider->photo ? asset('storage/' . $provider->photo) : asset('images/default-user.png')); ?>" 
                                    ...
                                    <h3 class="text-xl font-serif text-gray-900 mb-1 group-hover:text-rose-600 transition-colors">
                                        <?php echo e(ucfirst($provider->name)); ?>
                                    ...
                                    <p class="text-sm text-gray-500 line-clamp-2 mb-4 font-light">
                                        <?php echo e($provider->bio ?? 'Passionate about creating beautiful nail art and ensuring client satisfaction.'); ?>
                    ...
                    <div class="flex justify-between items-center pt-8">
                        <a href="<?php echo e(route('booking.step1')); ?>" class="text-gray-500 hover:text-gray-900 font-medium flex items-center gap-2 transition-colors">
                     ...
                     <div id="summaryCard" class="bg-gray-900 text-white rounded-2xl p-6 shadow-xl overflow-hidden relative">
                        ...
                        <div class="mb-6 pb-6 border-b border-gray-700 relative z-10">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-medium text-white"><?php echo e(auth()->user()->name ?? 'Guest'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4 mb-6 relative z-10 max-h-[30vh] overflow-y-auto custom-scrollbar pr-2">
                            ...
                            <?php $__currentLoopData = $selectedServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-start text-sm group">
                                    <div>
                                        <p class="text-gray-200 group-hover:text-white transition-colors"><?php echo e($service->name); ?></p>
                                        <p class="text-gray-500 text-xs"><?php echo e($service->duration_minutes); ?> mins</p>
                                    </div>
                                    <span class="text-gray-300"><?php echo e(number_format($service->price)); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <div class="border-t border-gray-700 pt-4 mb-6 relative z-10">
                            <div class="flex justify-between items-end">
                                ...
                                <span class="text-2xl font-serif text-white">RWF <?php echo e(number_format($totalPrice)); ?></span>
                            </div>
                            <div class="flex justify-between items-center mt-1">
                                <span class="text-gray-500 text-xs">Total Duration</span>
                                <span class="text-gray-400 text-xs"><?php echo e($totalDuration); ?> mins</span>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\booking\step2.blade.php ENDPATH**/ ?>