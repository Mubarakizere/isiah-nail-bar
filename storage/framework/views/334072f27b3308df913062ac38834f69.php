                    ...
                    <div class="w-full md:w-64">
                         <select id="categoryFilter" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-900 cursor-pointer">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="cat-<?php echo e($category->id); ?>"><?php echo e($category->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>

                <form method="POST" action="<?php echo e(route('booking.step1.submit')); ?>" id="servicesForm">
                    <?php echo csrf_field(); ?>
                    
                    <div class="space-y-8">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($category->services->isNotEmpty()): ?>
                                <div id="cat-<?php echo e($category->id); ?>" class="category-section scroll-mt-40">
                                    <div class="flex items-center gap-4 mb-4">
                                        <h3 class="text-xl font-serif text-gray-900"><?php echo e($category->name); ?></h3>
                                                    ...
                                                    <div class="w-2/3 p-4 flex flex-col justify-between">
                                                        <div>
                                                            <div class="flex justify-between items-start gap-2 mb-1">
                                                                <h4 class="font-medium text-gray-900 text-sm md:text-base group-hover:text-rose-600 transition-colors"><?php echo e($service->name); ?></h4>
                                                            ...
                                                            <p class="text-xs text-gray-500 line-clamp-2 mb-3"><?php echo e($service->description); ?></p>
                                                        </div>
                                                        
                                                        <div class="flex items-center justify-between text-sm">
                                                            <span class="font-bold text-gray-900"><?php echo e(number_format($service->price)); ?> <span class="text-xs font-normal text-gray-500">RWF</span></span>
                                                            <?php if($service->duration): ?>
                                                                <span class="text-xs text-gray-400 flex items-center gap-1">
                                                                    <i class="ph ph-clock"></i> <?php echo e($service->duration); ?>m
                                                                </span>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\booking\step1.blade.php ENDPATH**/ ?>