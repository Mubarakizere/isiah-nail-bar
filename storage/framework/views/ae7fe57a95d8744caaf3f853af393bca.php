    ...
    <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="mb-8 flex justify-center">
            <div class="w-24 h-24 bg-rose-50 rounded-full flex items-center justify-center">
                <i class="ph ph-lock-key text-4xl text-rose-500"></i>
            </div>
        </div>
        <h1 class="text-7xl font-bold text-gray-900 font-serif mb-4 tracking-tight">403</h1>
        <h2 class="text-2xl font-semibold text-gray-800 mb-4">Access Denied</h2>
        <p class="text-gray-500 mb-10 text-lg">
            You don't have permission to access this page. Please log in with appropriate credentials or check if you have the right access level.
        </p>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\errors\403.blade.php ENDPATH**/ ?>