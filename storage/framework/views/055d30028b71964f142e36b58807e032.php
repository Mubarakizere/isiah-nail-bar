...
<div class="p-6">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Tag</h1>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit" 
                        ...
                        <i class="ph ph-check-circle mr-2"></i>Update Tag
                    </button>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\admin\tags\edit.blade.php ENDPATH**/ ?>