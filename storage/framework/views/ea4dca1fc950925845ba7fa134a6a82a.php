                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm font-medium text-gray-700 capitalize">
                                        <?php echo e(str_replace('_', ' ', $log->type)); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($log->status === 'success' || $log->status === 'SUCCESS'): ?>
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-green-100 text-green-800">
                                            <i class="ph ph-check-circle mr-1"></i>Success
                                        </span>
                                    <?php elseif($log->status === 'failed' || $log->status === 'FAILED'): ?>
                                    ...
                                    <?php else: ?>
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-gray-100 text-gray-800">
                                            <?php echo e(ucfirst($log->status ?? 'N/A')); ?>
                                ...
                                <td class="px-6 py-4">
                                    <button type="button"
                                            ...
                                            data-payload="<?php echo e(json_encode($log->payload, JSON_PRETTY_PRINT)); ?>"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\admin\webhooks\index.blade.php ENDPATH**/ ?>