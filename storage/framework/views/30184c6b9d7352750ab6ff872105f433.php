...
<?php $__env->startSection('title', 'Complete Your Payment'); ?>

<?php $__env->startSection('content'); ?>
<div class="iframe-container" id="iframeContainer">
    <iframe src="<?php echo e($iframeUrl); ?>" 
            allow="payment *" 
...
const bookingReference = '<?php echo e(session("last_booking_reference") ?? ""); ?>';
...
function handlePaymentEvent(data) {
    ...
    switch (data.status) {
        ...
        case 'failed':
            ...
            if (bookingReference) {
                fetch(`<?php echo e(url('/booking/mark-failed')); ?>/${bookingReference}`, {
                    method: 'POST',
                    headers: {
...
function startPolling() {
    if (!bookingReference) {
        ...
        setTimeout(() => {
            window.location.href = "<?php echo e(route('booking.step1')); ?>?error=missing_reference";
        }, 2000);
        return;
    }
    ...
    pollingInterval = setInterval(() => {
        ...
        fetch(`<?php echo e(url('/booking/payment-status')); ?>/${bookingReference}`)
            .then(response => response.json())
            .then(data => {
                ...
                if (data.status === 'success') {
                    ...
                    setTimeout(() => {
                        window.location.href = "<?php echo e(route('booking.success')); ?>";
                    }, 1000);
                    ...
                    setTimeout(() => {
                        window.location.href = "<?php echo e(route('booking.step1')); ?>?error=payment_declined";
                    }, 2000);
                    ...
                    if (pollCount >= MAX_POLLS) {
                        ...
                        setTimeout(() => {
                            window.location.href = "<?php echo e(route('booking.step1')); ?>?warning=payment_timeout";
                        }, 3000);
                    }
                } else {
                    // Unknown status
...
<?php echo $__env->make('layouts.payment', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\booking\payment-iframe.blade.php ENDPATH**/ ?>