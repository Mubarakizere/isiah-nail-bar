...
<?php $__env->startSection('title', 'My Booking Calendar'); ?>
...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('dashboard.provider')); ?>" class="btn btn-outline-secondary btn-sm">
            ← Back to Dashboard
        </a>
    </div>
    ...
    <div class="row g-2 mb-3">
        ...
        <div class="col-md-4 text-end">
            <a href="<?php echo e(route('provider.calendar.ical')); ?>" class="btn btn-outline-primary">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: {
                url: '<?php echo e(route('provider.calendar.fetch')); ?>',
                method: 'GET',
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\dashboard\provider\calendar.blade.php ENDPATH**/ ?>