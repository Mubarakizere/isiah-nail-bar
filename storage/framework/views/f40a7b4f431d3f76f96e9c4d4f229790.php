<?php $__env->startSection('title', 'Request a New Service'); ?>
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
        <form method="POST" action="<?php echo e(route('provider.services.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\providers\services\request.blade.php ENDPATH**/ ?>