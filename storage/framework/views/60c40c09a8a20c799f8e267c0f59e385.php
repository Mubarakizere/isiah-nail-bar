...
<?php $__env->startSection('title', 'Confirm & Pay'); ?>
...
<div class="bg-white min-h-screen py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="<?php echo e(route('booking.step4.submit')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div class="lg:col-span-8 space-y-8">
                            ...
                            <label class="payment-option group relative cursor-pointer block">
                                ...
                                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm transition-all duration-300 peer-checked:border-gray-900 peer-checked:ring-1 peer-checked:ring-gray-900 peer-checked:bg-gray-50 h-full">
                                    <div class="flex justify-between items-start mb-4">
                                        ...
                                        <span class="text-lg font-bold text-gray-900">RWF <?php echo e(number_format($totalPrice)); ?></span>
                                    </div>
                            ...
                            <label class="payment-option group relative cursor-pointer block">
                                ...
                                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm transition-all duration-300 peer-checked:border-gray-900 peer-checked:ring-1 peer-checked:ring-gray-900 peer-checked:bg-gray-50 h-full">
                                     <div class="flex justify-between items-start mb-4">
                                        ...
                                        <span class="text-lg font-bold text-gray-900">RWF <?php echo e(number_format($depositAmount)); ?></span>
                                    </div>
                    ...
                    <div class="flex justify-between items-center pt-8 mt-8 border-t border-gray-100">
                        <a href="<?php echo e(route('booking.step3')); ?>" class="text-gray-500 hover:text-gray-900 font-medium flex items-center gap-2 transition-colors">
                        ...
                        <div class="bg-gray-900 text-white rounded-2xl p-6 shadow-xl overflow-hidden relative">
                            ...
                            <div class="space-y-4 mb-6 pb-6 border-b border-gray-700 relative z-10 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-white font-medium"><?php echo e(session('booking.date')); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-400">Time</span>
                                    <span class="text-white font-medium"><?php echo e(\Carbon\Carbon::createFromFormat('H:i', session('booking.time'))->format('h:i A')); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-400">Artist</span>
                                    <span class="text-rose-400 font-medium"><?php echo e($provider->name); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="bg-rose-900/30 border border-rose-500/30 rounded-xl p-4 mb-6 relative z-10 text-sm">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-300"><?php echo e(session('booking.address')); ?></p>
                            ...
                            <div class="bg-blue-900/30 border border-blue-500/30 rounded-xl p-4 mb-6 relative z-10 text-sm">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-300"><?php echo e(session('booking.pickup_address')); ?></p>
                                        <p class="text-blue-400 text-xs mt-2 italic">+<?php echo e(number_format($pickupLoc->fee)); ?> RWF added to total</p>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="border-t border-gray-700 pt-4 mb-6 relative z-10">
                                <div class="flex justify-between items-end mb-2">
                                    ...
                                    <span class="text-xl font-serif text-white">RWF <?php echo e(number_format($totalPrice)); ?></span>
                                </div>
                                <div class="flex justify-between items-end">
                                    <span class="text-rose-400 text-sm font-medium">To Pay Now</span>
                                    <span  id="payAmountDisplay" class="text-2xl font-serif text-rose-400 font-bold">RWF <?php echo e(number_format($totalPrice)); ?></span>
                                </div>
                            </div>

                            <button type="submit" 
                                    id="payNowBtn"
                                    <?php echo e($isLocal ? 'disabled' : ''); ?>

                                    class="w-full py-4 bg-white text-gray-900 font-bold rounded-xl hover:bg-rose-50 transition-all flex items-center justify-center gap-2 group relative z-10 <?php echo e($isLocal ? 'opacity-75 cursor-not-allowed' : ''); ?>">
...
document.querySelectorAll('input[name="payment_option"]').forEach(radio => {
    radio.addEventListener('change', function() {
        ...
        const total = <?php echo e($totalPrice); ?>;
        const deposit = <?php echo e($depositAmount); ?>;
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\booking\step4.blade.php ENDPATH**/ ?>