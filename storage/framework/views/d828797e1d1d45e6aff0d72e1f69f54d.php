...
<div class="p-6">
    <div class="mb-8">
        ...
        <p class="text-gray-600">Update profile for <?php echo e($teamMember->name); ?></p>
    </div>

    <div class="max-w-3xl">
        <div class="bg-white rounded-2xl shadow-md border border-gray-200 p-8">
            <form action="<?php echo e(route('admin.team_members.update', $teamMember->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $teamMember->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="role" value="<?php echo e(old('role', $teamMember->role)); ?>" required placeholder="e.g. Receptionist, Manager"
                               class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent transition">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="bio" rows="4" 
                              class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent transition"><?php echo e(old('bio', $teamMember->bio)); ?></textarea>
                    <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="display_order" value="<?php echo e(old('display_order', $teamMember->display_order)); ?>"
                               class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent transition">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="active" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent transition">
                            <option value="1" <?php echo e(old('active', $teamMember->active) == 1 ? 'selected' : ''); ?>>Active</option>
                            <option value="0" <?php echo e(old('active', $teamMember->active) == 0 ? 'selected' : ''); ?>>Inactive</option>
                        </select>
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-gray-400 transition cursor-pointer bg-gray-50 relative" id="drop-zone">
                        <div class="space-y-1 text-center">
                         ...
                         <?php if($teamMember->photo): ?>
                            <img id="preview-image" src="<?php echo e(Storage::url($teamMember->photo)); ?>" alt="Preview" class="absolute inset-0 w-full h-full object-cover rounded-lg">
                        <?php else: ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\admin\team_members\edit.blade.php ENDPATH**/ ?>