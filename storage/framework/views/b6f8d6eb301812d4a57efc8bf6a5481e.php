...
<?php $__env->startSection('title', 'Final Confirmation'); ?>
...
<div class="bg-white min-h-screen py-12">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <form method="POST" action="<?php echo e(route('booking.step5.submit')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2 space-y-8">
                       ...
                       <div class="w-12 h-12 rounded-full bg-rose-50 flex items-center justify-center text-rose-500 shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900 mb-1">
                                <?php echo e(\Carbon\Carbon::parse(session('booking.date'))->format('l, F j')); ?>

                            </p>
                            <p class="text-gray-500 font-medium">
                                at <?php echo e(\Carbon\Carbon::parse(session('booking.time'))->format('h:i A')); ?>
                    ...
                    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex items-start gap-5">
                       <div class="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-500 shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-gray-900"><?php echo e($provider->name); ?></p>
                            <?php if($provider->bio): ?>
                                <p class="text-sm text-gray-500 mt-1 line-clamp-1"><?php echo e($provider->bio); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex items-start gap-5">
                       <div class="w-12 h-12 rounded-full <?php echo e(session('booking.is_home_service') ? 'bg-rose-50 text-rose-500' : 'bg-green-50 text-green-500'); ?> flex items-center justify-center shrink-0">
                            <i class="ph <?php echo e(session('booking.is_home_service') ? 'ph-house' : 'ph-storefront'); ?> text-2xl"></i>
                        </div>
                        <div>
                            <h3 class="text-lg font-serif text-gray-900 mb-1">Where</h3>
                            <p class="text-xl font-bold text-gray-900"><?php echo e(session('booking.is_home_service') ? 'Home Service' : 'In-Salon Service'); ?></p>
                            <?php if(session('booking.is_home_service')): ?>
                                <p class="text-sm text-gray-500 mt-1 line-clamp-2"><?php echo e(session('booking.address')); ?></p>
                            <?php else: ?>
                    ...
                    <div>
                         ...
                         <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100 space-y-4">
                                ...
                                <div class="flex justify-between items-center group">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500"><?php echo e($service->duration_minutes); ?> mins</p>
                                        </div>
                                    </div>
                            ...
                            <div class="pt-4 mt-4 border-t border-gray-200 space-y-2">
                                ...
                                <?php elseif(isset($pickupLoc) && session('booking.pickup_location_id')): ?>
                                <div class="flex justify-between items-center text-blue-500 text-sm">
                                    <div class="flex items-center gap-1">
                                        <i class="ph ph-car"></i>
                                        <span>Pickup: <?php echo e($pickupLoc->name); ?></span>
                                    </div>
                                    <span>+<?php echo e(number_format($pickupLoc->fee)); ?> RWF</span>
                                </div>
                                <div class="text-xs text-gray-500 pl-5">
                                    Address: <?php echo e(session('booking.pickup_address')); ?>

                                </div>
                                <?php endif; ?>
                                <div class="flex justify-between items-center">
                                    <span class="font-serif">Total</span>
                                    <span class="font-bold text-lg">RWF <?php echo e(number_format($totalPrice)); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e(auth()->user()->phone ?? 'N/A'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-24">
                        <div class="bg-gray-900 text-white rounded-2xl p-6 shadow-xl relative overflow-hidden">
                            ...
                            <div class="space-y-4 mb-8 relative z-10">
                                <div class="flex justify-between items-center text-sm text-gray-400">
                                    ...
                                    <span><?php echo e($services->sum('duration_minutes')); ?> mins</span>
                                </div>
                                <div class="flex justify-between items-center text-sm text-gray-400">
                                    <span>Service Count</span>
                                    <span><?php echo e($services->count()); ?> services</span>
                                </div>
                                 <div class="h-px bg-gray-800 my-4"></div>
                                 <div class="flex justify-between items-end">
                                    <span class="text-lg">Grand Total</span>
                                    <span class="text-3xl font-serif text-white">RWF <?php echo e(number_format($totalPrice)); ?></span>
                                </div>
                            </div>
                        ...
                        <a href="<?php echo e(route('booking.step4')); ?>" class="block text-center mt-6 text-gray-500 hover:text-gray-900 text-sm font-medium transition-colors">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\booking\step5.blade.php ENDPATH**/ ?>