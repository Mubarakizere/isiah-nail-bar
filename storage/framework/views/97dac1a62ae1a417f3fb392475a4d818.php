...
<?php $__env->startSection('title', 'Artist Studio'); ?>
<?php $__env->startSection('page-subtitle', 'Manage your schedule and track your performance.'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] border border-gray-100 group hover:border-gray-200 transition-colors">
            ...
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-900 mt-1"><?php echo e(number_format($total)); ?></h3>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] border border-gray-100 group hover:border-gray-200 transition-colors">
            ...
            <div>
                ...
                <h3 class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($rate); ?>%</h3>
            </div>
            <div class="mt-4 pt-4 border-t border-gray-50">
                 <div class="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                    <div class="bg-teal-500 h-1.5 rounded-full" style="width: <?php echo e($rate); ?>%"></div>
                </div>
            </div>
        </div>
            ...
            <div class="absolute top-0 right-0 p-4 opacity-5">
             ...
             <div class="relative z-10">
                ...
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-white mt-1">RWF <?php echo e(number_format($revenue)); ?></h3>
                </div>
                 <div class="mt-4 pt-4 border-t border-gray-700 flex justify-end">
                    <a href="<?php echo e(route('provider.earnings.pdf')); ?>" class="text-xs flex items-center gap-1 hover:text-white text-gray-300 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500"><?php echo e(now()->format('l, F j')); ?></span>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border border-gray-100 overflow-hidden">
                             ...
                             <?php $__empty_1 = true; $__currentLoopData = $myBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="group hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="font-mono font-medium text-gray-900"><?php echo e(\Carbon\Carbon::parse($booking->time)->format('H:i')); ?></span>
                                        <p class="text-xs text-gray-400"><?php echo e(\Carbon\Carbon::parse($booking->date)->isToday() ? 'Today' : \Carbon\Carbon::parse($booking->date)->format('M d')); ?></p>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-8 h-8 rounded-full bg-rose-100 flex items-center justify-center text-rose-600 font-bold text-xs ring-2 ring-white">
                                                <?php echo e(strtoupper(substr($booking->customer->user->name ?? 'G', 0, 1))); ?>

                                            </div>
                                            <span class="font-medium text-gray-900"><?php echo e($booking->customer->user->name ?? 'Guest'); ?></span>
                                        </div>
                                        <?php if($booking->is_home_service): ?>
                                            <div class="mt-1.5 text-xs text-rose-600 font-bold flex items-start gap-1">
                                                ...
                                                <span class="break-words max-w-[150px]"><?php echo e(Str::limit($booking->address, 20)); ?></span>
                                            </div>
                                        <?php elseif($booking->pickup_location_id): ?>
                                            <div class="mt-1.5 text-xs text-blue-600 font-bold flex items-start gap-1">
                                                ...
                                                <span class="break-words max-w-[150px]">Pickup at <?php echo e(Str::limit($booking->pickup_address, 20)); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                             <?php $__currentLoopData = $booking->services->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                 <span class="text-sm text-gray-700"><?php echo e($service->name); ?></span>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                             <?php if($booking->services->count() > 1): ?>
                                                <span class="text-xs bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded-md">+<?php echo e($booking->services->count() - 1); ?> more</span>
                                             <?php endif; ?>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        ...
                                        ?>
                                        <span class="px-2.5 py-1 rounded-full text-xs font-medium border <?php echo e($statusStyles); ?>">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                             <?php if($booking->status === 'pending'): ?>
                                                <form method="POST" action="<?php echo e(route('provider.booking.action', ['id' => $booking->id, 'action' => 'accept'])); ?>">
                                                    <?php echo csrf_field(); ?>
                                                ...
                                                <form method="POST" action="<?php echo e(route('provider.booking.action', ['id' => $booking->id, 'action' => 'decline'])); ?>">
                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php elseif($booking->status === 'accepted'): ?>
                                                <form method="POST" action="<?php echo e(route('provider.booking.complete', $booking->id)); ?>">
                                                    <?php echo csrf_field(); ?>
                ...
                <div class="p-4 border-t border-gray-100 bg-gray-50/50 text-center">
                    <a href="<?php echo e(route('provider.calendar')); ?>" class="text-sm font-medium text-gray-600 hover:text-rose-600 transition-colors">View Monthly Calendar &rarr;</a>
                </div>
            </div>
        </div>
             ...
             <div class="bg-white rounded-3xl p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border border-gray-100 h-full">
                ...
                <div class="mt-6 space-y-3">
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                        ...
                        <span class="font-bold text-gray-900">RWF <?php echo e(number_format($chartData->sum('total'))); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    if (ctx) {
        ...
        new Chart(ctx, {
            type: 'line',
            data: {
                labels: <?php echo json_encode($chartData->pluck('label')); ?>,
                datasets: [{
                    label: 'Revenue',
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\dashboard\provider.blade.php ENDPATH**/ ?>