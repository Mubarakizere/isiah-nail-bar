...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">Detailed metrics for <strong><?php echo e($provider->user->name ?? 'N/A'); ?></strong></p>
            </div>
            <a href="<?php echo e(route('dashboard.admin.reports.pdf')); ?>" 
               class="px-6 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition shadow-lg">
                <i class="ph ph-file-pdf mr-2"></i>Download PDF
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-600 mt-1">Daily revenue performance breakdown</p>
        </div>
