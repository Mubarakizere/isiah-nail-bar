...
<?php $__env->startSection('title', 'Pay Remaining Balance'); ?>
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $booking->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between py-2 border-b">
                            <span class="text-gray-700"><?php echo e($service->name); ?></span>
                            <span class="font-semibold">RWF <?php echo e(number_format($service->price)); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <div class="flex justify-between py-2 border-b font-semibold">
                        <span>Total</span>
                        <span>RWF <?php echo e(number_format($booking->services->sum('price'))); ?></span>
                    </div>

                    <div class="flex justify-between py-2 border-b text-green-600">
                        <span>Deposit Paid</span>
                        <span>RWF <?php echo e(number_format($booking->deposit_amount)); ?></span>
                    </div>

                    <div class="flex justify-between py-3 text-red-600 font-bold text-lg">
                        <span>Remaining Balance</span>
                        <span>RWF <?php echo e(number_format($remainingAmount)); ?></span>
                    </div>
                </div>
            </div>

            
            <form method="POST" action="<?php echo e(route('customer.booking.payRemainingPost', $booking->id)); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouba\isaiahnailbar\resources\views\booking\pay-remaining.blade.php ENDPATH**/ ?>