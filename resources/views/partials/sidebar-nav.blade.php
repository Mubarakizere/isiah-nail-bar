        ...
        <div class="border-b border-gray-800 pb-2">
            ...
            <div x-show="managementOpen" x-collapse class="mt-1 space-y-0.5">
                ...
                <a href="{{ route('admin.hero-slides.index') }}" 
                   class="group flex items-center gap-2 px-3 py-2 text-sm font-medium transition-colors {{ request()->routeIs('admin.hero-slides.*') ? 'bg-rose-600 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <i class="ph ph-slideshow text-base"></i>
                    <span>Hero Slides</span>
                </a>

                <a href="{{ route('admin.pickup-locations.index') }}" 
                   class="group flex items-center gap-2 px-3 py-2 text-sm font-medium transition-colors {{ request()->routeIs('admin.pickup-locations.*') ? 'bg-rose-600 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
